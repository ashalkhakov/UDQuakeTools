...
@interface UDGameDetectionTests : XCTestCase
@end

@implementation UDGameDetectionTests
...
- (void)testGameDetection {
    ...
    XCTAssertEqual(game1.type, UDGameTypeQuake1, @"Should detect Quake 1 for id1 parent folder");
    ...
    XCTAssertEqual(game2.type, UDGameTypeDoom3, @"Should detect Doom 3 for base parent folder");
    ...
    XCTAssertEqual(game3.type, UDGameTypeQuake3, @"Should detect Quake 3 for pk3 extension");
    ...
    XCTAssertEqual(game4.type, UDGameTypeDoom3, @"Should detect Doom 3 for pk4 extension");
    ...
    XCTAssertEqual(game5.type, UDGameTypeQuake2, @"Should detect Quake 2 for wal files");
    ...
    XCTAssertEqual(game6.type, UDGameTypeDoom3, @"Should detect Doom 3 for materials/mtr files");
    ...
    XCTAssertEqual(game7.type, UDGameTypeDaikatana, @"Should detect Daikatana for com.udquake.daikatana-pak codec");
}
